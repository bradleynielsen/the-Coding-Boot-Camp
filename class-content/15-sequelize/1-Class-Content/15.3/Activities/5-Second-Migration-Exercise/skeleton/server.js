/* 5-Migrations Exercise 2
 * -/-/-/-/-/-/-/-/- */


/* Students:
 * Create a migration file that inserts 5 entries into the user table. 
 * And don't forget to add the function that destroys those five entries.
 * TIP: bring in the user model to make your life 1000 times easier.
 *
 * Good Luck!
 * ==================================================================== */
