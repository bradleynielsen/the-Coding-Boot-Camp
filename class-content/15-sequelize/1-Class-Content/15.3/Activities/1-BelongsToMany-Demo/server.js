 ...
 *  A) The two BelongsToMany associations called between Fandom and User,
 *	   and how the UserFandom model get's referenced there as well.
 *  B) The creation of the two fandoms and their association with users using addFandom
 *  C) The addition of brad to the Twin Peaks fandom using addUser
 *  D) Retrieving all of a user's fandoms.
 *  E) Retrieving all of a fandom's users.
 *
