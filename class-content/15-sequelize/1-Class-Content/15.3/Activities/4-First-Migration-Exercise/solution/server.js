/* 4-Migrations Exercise 1
 * (((SOLVED)))
 * -/-/-/-/-/-/-/-/- *


/* Students:
 * Create a migration file that inserts a fullName column into your table. 
 * Add the fullName column to the User model, and prevent the fullName column from 
 * accepting null values. Add in fullNames to the users in server.js
 *
 * Good Luck!
 * ==================================================================== */
...
// reach into our models object, 
// and create each table based on the associated model.
