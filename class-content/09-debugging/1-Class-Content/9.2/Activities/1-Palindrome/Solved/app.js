/**
 * Reverse in Place and Palindrome
 **/
...
// Our palindrome detector takes in a sentence, or s.
function palindromeDetector (s) {
  ...
  for (var i=0;i<words.length;i++){
    ...
    // Removes all non-letters with RegEx for bonus.
  ...
  for(var j=0; j<reversedArray.length;j++){
    ...
    // Checks to see if a word is longer than one letter 
    // and checks the reversed word agains the unreversed word. (
    ...
    // Otherwise,
      ...
      // it's not a palindrome, just push the plain word!
      showOnPage.push(reversedArray[j]);
    }
  }

  // Replace the contents of the "result" div 
  // with the merged showOnPage array.
